  ...
  return (
    <div className="min-h-screen text-white overflow-hidden" style={{background:"linear-gradient(135deg, #000000 0%, #0a0a0a 100%)"}}>
      ...
      <div className="fixed right-10 top-1/2 transform -translate-y-1/2 flex flex-col gap-6 z-20">
        <a href="https://www.linkedin.com/in/kishoore-j-9081b5349/" className="text-gray-400 hover:text-[#D4AF37] transition text-2xl"><i className="fab fa-linkedin-in"></i></a>
        <a href="#" className="text-gray-400 hover:text-[#D4AF37] transition text-2xl"><i className="fab fa-instagram"></i></a>
        <a href="https://github.com/Jk2006k" className="text-gray-400 hover:text-[#D4AF37] transition text-2xl"><i className="fab fa-github"></i></a>
        <a href="#" className="text-gray-400 hover:text-[#D4AF37] transition text-2xl"><i className="fab fa-whatsapp"></i></a>
      </div>
